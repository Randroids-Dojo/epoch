 ...
 *
 * Composes shared EpochRecord into a TimelineRecording suitable for URL
 * sharing. Encodes recordings to compact base64url strings and decodes
 * them back with validation.
 */

import { EpochRecord } from './timeline';
...
/** A complete recorded game timeline for sharing. Composes shared EpochRecord. */
export interface TimelineRecording {
  /** Schema version for forward-compat. */
  v: 1;
  /** Map seed used for this game. */
  seed: number;
  /** Commands issued each epoch (index 0 = epoch 1). Uses shared EpochRecord. */
  epochs: EpochRecord[];

...
describe('generateAICommands — military', () => {
  ...
  it('attacks visible enemy unit in range (Aggressor blend)', () => {
    ...
    state.units.set(rangerId, {
      ...
      hp: UNIT_DEFS.arc_ranger.maxHp, isDefending: false, assignedExtractorId: null, damageShield: false, mergeCount: 0, bonusMaxHp: 0, bonusAttack: 0, attackTargetHex: null,
    });
    ...
    state.units.set(pId, {
      ...
      hp: UNIT_DEFS.drone.maxHp, isDefending: false, assignedExtractorId: null, damageShield: false, mergeCount: 0, bonusMaxHp: 0, bonusAttack: 0, attackTargetHex: null,
    });
  ...
  it('moves combat units toward map center when no target visible', () => {
    ...
    state.units.set(sentryId, {
      ...
      hp: UNIT_DEFS.pulse_sentry.maxHp, isDefending: false, assignedExtractorId: null, damageShield: false, mergeCount: 0, bonusMaxHp: 0, bonusAttack: 0, attackTargetHex: null,
    });
